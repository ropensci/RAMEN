...
#'
#' Simulated M values of the 3000 probes selected in *test_array_manifest* for
#' 30 individuals. Values were converted from beta values, which were drawn from
#' a bimodal Beta distribution.
#'
